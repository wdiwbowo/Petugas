...
export const router = createBrowserRouter([
  ...
  { path: "/activateAccountForm", element: <ActivateAccountForm /> },
  {
    path: "/profile",
    element: (
      <PrivateRoute element={<Profile />} isAuthenticated={isAuthenticated} />
    ),
  },
  {
    path: "/laporan",
    element: (
      <PrivateRoute element={<Laporan />} isAuthenticated={isAuthenticated} />
    ),
  },
  {
    path: "/presensi",
    element: (
      <PrivateRoute element={<Presensi />} isAuthenticated={isAuthenticated} />
    ),
  },
]);
