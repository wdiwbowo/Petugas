...
const dummyLaporanData = [
    { id: 1, nama: 'John Doe', tanggal: '2024-09-01', jumlah: 100, status: 'Completed' },
    { id: 2, nama: 'Jane Smith', tanggal: '2024-09-02', jumlah: 150, status: 'Pending' },
    { id: 3, nama: 'Alice Johnson', tanggal: '2024-09-03', jumlah: 200, status: 'Completed' },
    { id: 4, nama: 'Bob Brown', tanggal: '2024-09-04', jumlah: 250, status: 'In Progress' },
    { id: 5, nama: 'Charlie Black', tanggal: '2024-09-05', jumlah: 300, status: 'Completed' },
];
...
const Laporan = () => {
    ...
    const handleAdd = () => {
        // Implement functionality for adding a new report
    };
                            ...
                            <tbody className="bg-gray-800 divide-y divide-gray-700">
                                {currentItems.map((item, index) => (
                                    <tr key={item.id} className="hover:bg-yellow-600 hover:text-gray-900 transition duration-300">
                                        ...
                                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-400">{item.jumlah}</td>
